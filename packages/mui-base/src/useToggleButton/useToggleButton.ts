...
// import { UseToggleButtonParameters, UseTabReturnValue, UseTabRootSlotProps } from './UseToggleButton.types';
import { UseToggleButtonParameters } from './useToggleButton.types';
/**
 *
 * Demos:
 *
...
function useToggleButton(parameters: UseToggleButtonParameters) {
